...
export default function ReportSheet({ open, onClose, onSubmit, title = 'Report', description }) {
  ...
  return (
    <>
      <style>{`
        .rt-report-backdrop { position:fixed; inset:0; z-index:1200; background:rgba(0,0,0,0.5); display:flex; align-items:flex-end; justify-content:center; }
        .rt-report-sheet    { background:var(--rt-bg); border-radius:1.25rem 1.25rem 0 0; padding:1.75rem 1.5rem 2.5rem; width:100%; max-width:480px; box-shadow:0 -4px 32px rgba(0,0,0,0.2); }
