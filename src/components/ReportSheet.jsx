...
export default function ReportSheet({ open, onClose, onSubmit, title = 'Report', description }) {
  ...
  return (
    <div
      style={{ position: 'fixed', inset: 0, zIndex: 1100, background: 'rgba(0,0,0,0.45)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}
      onClick={e => { if (e.target === e.currentTarget) handleClose() }}
    >
      <div style={{ background: 'var(--rt-bg)', borderRadius: '1.25rem 1.25rem 0 0', padding: '1.75rem 1.5rem 2.5rem', width: '100%', maxWidth: 480, boxShadow: '0 -4px 32px rgba(0,0,0,0.15)' }}>
